...
class StageRuntime:
    def __init__(self, model, distributed_backend, fp16, loss_scale,
                 ...
                 model_type, input_path, enable_recompute=False, batch_s=192, rep=1):
    ...
    def initialize(self, model, inputs_module_destinations,
        ...
        if True:#self.is_first_stage:
            # 104,999, 23, 44, 31, 41, 999, 50, 999, 6, 999, 999, 999, 4,  61,16, 14, 999, 999, 999,999, 7, 6, 999, 999,  4,248, 999,
            self.test_input_0 = [[ 9, 999, 5,  2]*self.rep]*self.batch_s
            # 104,333, 23, 44, 31, 41, 333, 50, 444, 6, 444, 555, 666, 4,  61,16, 14, 666, 666, 999,999, 7, 6, 999, 99,  4,99, 99,
            # print("test input 0", len(self.test_input_0), len(self.test_input_0[0]))
            self.test_input_1 = [[2, 9, 999, 5]*self.rep]*self.batch_s
    ...
    def receive_tensors_forward(self): #, blocking = True):
        ...
        input_t = self.batch_s * self.rep * 4
    ...
    def run_forward(self, idx=None, recompute_step=False):
        ...
        #print("Forward: Stage ", self.stage, "keys ", tensors.keys(), " seq ", seq_id)
        #tensors = self.tensors[-1]
    ...
    def run_backward(self):
        ...
        #print("Stage ", self.stage, " buffer length", len(self.tensors))
