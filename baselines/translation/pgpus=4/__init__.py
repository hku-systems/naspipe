...
class Task():
    def __init__(self):
        self.source_dictionary = Dictionary.load('data/wmt14_en_de_joined_dict/dict.en.perf.txt')
        self.target_dictionary = Dictionary.load('data/wmt14_en_de_joined_dict/dict.de.perf.txt')
...
def forward_cuda_hook(*args):
    ...
    for p in module.parameters():
        ...
        # weight stash too much memory consumption, ignore first
        #p.weight_stash = torch.randn(p.shape_, dtype=p.dtype_, device=torch.device('cuda'))
