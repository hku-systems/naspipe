...
class TranslationTask(FairseqTask):
    ...
    def setup_task(cls, args, **kwargs):
        ...
        # load dictionaries
        src_dict = Dictionary.load(os.path.join(args.data, 'dict.{}.perf.txt'.format(args.source_lang)))
        tgt_dict = Dictionary.load(os.path.join(args.data, 'dict.{}.perf.txt'.format(args.target_lang)))
