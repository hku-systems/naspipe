...
def main():
    ...
    r = runtime.StageRuntime(
        ...
        enable_recompute=args.recompute, input_path=args.input_path)
...
def schedule(buffer_list, wait_list, ops, stage):
    ...
    #print(ops[0])
    #if stage == 7:
        #print("Buffer list ", buffer_list, "Wait list ", wait_list)
...
def train(train_loader, r, optimizer, epoch, lr_scheduler):
    ...
    for t in range(1, total_updates+1):
        ...
        while True:
            ...
            while seq_id < 0 and len(r.buffer_list) <50 and r.receive_tensors_forward():
            ...
            if seq_id >= 0:
                #print("Stage ", r.stage, ": pre forward ", seq_id)
            ...
            if r.receive_tensors_backward() and not (is_last_stage() and seq_id < 0):
